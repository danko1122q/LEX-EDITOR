...
| `keywords2` | Array | Second group of keywords, typically for data types |
| `keywords3` | Array | Third group of keywords, typically for built-in functions or special identifiers |
...
* **keywords1** - Usually for control flow keywords: `if`, `else`, `for`, `while`, `return`, etc.
* **keywords2** - Usually for data types: `int`, `char`, `float`, `string`, `bool`, etc.
* **keywords3** - Usually for special keywords: built-in functions, constants, or language-specific identifiers

## Example: Python Syntax File

Here's an example of how to create a syntax file for Python:
...
Save this file as `python.json` in your syntax directory.
...
4. **Check existing files** - Look at built-in syntax files for examples and patterns
